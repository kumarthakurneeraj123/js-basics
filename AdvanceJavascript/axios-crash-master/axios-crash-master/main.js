...
function addTodo() {
  ...
  axios.post('https://jsonplaceholder.typicode.com/todos',{
      title:'New Todo',
      completed:'false'}).then(res=>showOutput(res)).catch(err=>console.log(err));
}
...
function customHeaders() {
  ...
  axios.post('https://jsonplaceholder.typicode.com/todos',{
      title:'New Todo',
      completed:'false'}, config).then(res=>showOutput(res)).catch(err=>console.log(err));
}
...
function errorHandling() {
  axios('https://jsonplaceholder.typicode.com/todoss',//{
    ...
    //   return status>400;//Reject only if status is greater or equal to 400;
    // }
  //}
  )
  .then(res=>showOutput(res))
